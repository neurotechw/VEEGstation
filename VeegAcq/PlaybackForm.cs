    ...
    { 
       ...
       /// </summary>
        ...
        public PlaybackForm(NationFile EegFile)
        {
            ...
            DT = EegFile.StartDateTime; // --by zt
            GetHsprogressMax();
      ...
      /// <param name="Line"></param>
        ...
        {
            return _nfi.StartDateTime.Hour*3600+_nfi.StartDateTime.Minute*60+_nfi.StartDateTime.Second;
        }
        /// 图表大小改变触发事件
        /// -- by lxl
        /// </summary>
